...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Feb 2024 pada 04.01
...
(7, 'SKM-002', 'Irgi Mahendra', 'Laki-laki', 'Cimahi', '089999899127'),
...
INSERT INTO `tb_skema` (`Kd_skema`, `Nm_skema`, `Jenis`, `Jml_unit`, `Tahun`) VALUES
('SKM-001', 'Junior Web Developer', 'KKNI', 6, 0),
('SKM-002', 'Digital Marketing', 'Klaster', 10, 0),
('SKM-003', 'Desainer Multimedia Muda', 'KKNI', 10, 0),
('SKM-004', 'Network Administrator Muda', 'KKNI', 5, 0),
('SKM-005', 'Mobile Programming', 'KKNI', 99, 2024);
